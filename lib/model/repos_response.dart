...
List<ReposResponse> reposResponseFromJson(String str) =>
    List<ReposResponse>.from(
        json.decode(str).map((x) => ReposResponse.fromJson(x)));

String reposResponseToJson(List<ReposResponse> data) =>
...
class ReposResponse {
  ...
  factory ReposResponse.fromJson(Map<String, dynamic> json) => ReposResponse(
        id: json["id"],
        nodeId: json["node_id"],
        name: json["name"],
